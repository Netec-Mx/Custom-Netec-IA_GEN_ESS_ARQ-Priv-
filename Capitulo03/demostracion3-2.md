...
### Paso 1: Preparar el criterio de evidencia

**Objetivo:** Observar y analizar este momento de la demostración.

**Instrucciones:**

1. Crea tres columnas en tus notas: afirmación, evidencia localizada y estado de validación.
...
### Paso 2: Observar la carga del archivo

**Objetivo:** Observar y analizar este momento de la demostración.

**Instrucciones:**

1. Confirma qué archivo usa el instructor y cuál es su propósito.
2. Observa qué preguntas iniciales ayudan a entender su contenido.
...
1. Anota las respuestas de Copilot a preguntas de datos concretos.
2. Comprueba si puedes localizar esos datos en la fuente.
...
### Paso 4: Pedir soporte explícito

**Objetivo:** Observar y analizar este momento de la demostración.

**Instrucciones:**

1. Observa cómo el instructor pide indicar sección, fragmento o ubicación de la evidencia.
2. Marca las respuestas que sí quedan sustentadas.
...
### Paso 5: Provocar una pregunta fuera de alcance

**Objetivo:** Observar y analizar este momento de la demostración.

**Instrucciones:**

1. Observa una pregunta cuya respuesta no exista en el archivo.
2. Comprueba si Copilot reconoce la ausencia o intenta completar con información externa/inferida.
...
### Paso 6: Corregir una respuesta no sustentada

**Objetivo:** Observar y analizar este momento de la demostración.

**Instrucciones:**

1. Observa el prompt de corrección que limita la respuesta exclusivamente a la fuente.
2. Anota cómo cambia la salida.
...
### Paso 7: Cerrar el reto de evidencia

**Objetivo:** Observar y analizar este momento de la demostración.

**Instrucciones:**

1. Resume dos señales que indican que una respuesta necesita verificación adicional.
...
```text
Responde únicamente con base en el archivo adjunto.
Para cada afirmación relevante, indica dónde está sustentada en la fuente.
Si la respuesta no está en el archivo, escribe "No disponible en la fuente".
```
